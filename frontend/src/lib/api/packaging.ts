...
// Releitura pontual só do saldo materializado de UMA embalagem — usada pelo
// ajuste por quantidade absoluta (StockItemAdjustDialog) logo antes de
...
// outro usuário. Espelha getAccessoryCurrentStock: leitura direta (SELECT já
// concedido a authenticated, RLS is_active_user()), nunca uma escrita.
export async function getPackagingCurrentStock(id: string): Promise<number> {
